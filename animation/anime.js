...
anime({
    targets: '.staggering-grid-demo .el',
    translateX: anime.stagger(10, { grid: [3, 1], from: 'center', axis: 'x' }),
    translateY: anime.stagger(10, { grid: [3, 1], from: 'center', axis: 'y' }),
    rotateZ: anime.stagger([0, 90], { grid: [3, 1], from: 'center', axis: 'x' }),
    rotateY: anime.stagger([0, 90], { grid: [3, 1], from: 'center', axis: 'x' }),
    delay: anime.stagger(200, { grid: [3, 1], from: 'center' }),
